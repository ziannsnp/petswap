# ADR 0006: Resolve username sign-in inside a Supabase Edge Function
...
Changing the username-sign-in protocol or storing email outside Supabase Auth requires a later ADR. Login UI and TanStack mutation wiring remain separate from the adapter and Edge Function.
